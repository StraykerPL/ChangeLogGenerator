...
namespace ChangeLog_Generator
{
    public partial class main : Form
    {
        ...
        public void NewFileButton_Click(object sender, EventArgs e) // New file button:
        {
            ...
            if (lang == "en") folderBrowserDialog1.Description = "Choose directory to create file in:";
            else if(lang == "pl") folderBrowserDialog1.Description = "Wybierz ścieżkę, gdzie ma być wygenerowany plik";
